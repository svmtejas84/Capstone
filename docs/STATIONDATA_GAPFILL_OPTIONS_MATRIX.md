...
The current derived station layer does not include observed 2023 sensor rows; that year remains missing from the source pulls and is intentionally left out of `data/processed/stations/`.

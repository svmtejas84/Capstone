...
| File | Format | Purpose |
|---|---|---|
| `station_timeseries_observed_imputed.parquet` | Parquet | Station dataset for V100 use, copied from gapfill derived layer |
| `station_timeseries_imputation_summary.parquet` | Parquet | Station imputation summary for quick QA in station workflows |
| `station_timeseries_unresolved_index.parquet` | Parquet | Any unresolved station records carried into station workflows |
...
- Load `stations/station_timeseries_observed_imputed.parquet` when you need the processed station layer.
